...
function search(
  queryArg, path, extns, isCaseInsensitive, isNotRecursive, searchHidden) {
  ...
  dir.files(path, function(err, files) {
    ...
    var filesToSearch = filter(path, files, extns, isNotRecursive, searchHidden);
...
function filter(path, files, extns, isNotRecursive, searchHidden) {
  var filteredFiles = [];
